...
- `repo_env`: name of the shell variable that holds the URL (for overrides, e.g. `UTILITY_TYPES_REPO`)
- `ref_env`: name of the shell variable that holds the ref (e.g. `UTILITY_TYPES_REF`)
