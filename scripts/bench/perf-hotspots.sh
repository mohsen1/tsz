...
DEFAULT_FILTER_FULL='^(DeepPartial optional-chain N=400|Recursive utility aliases N=120|Recursive utility aliases N=240|Shallow optional-chain N=400|200 union members|200 generic functions|Constraint conflicts N=200|200 classes|ts-toolbelt-project)$'
DEFAULT_FILTER_QUICK='^(DeepPartial optional-chain N=50|Recursive utility aliases N=30|Shallow optional-chain N=50|50 generic functions|100 classes|Constraint conflicts N=30|ts-toolbelt-project)$'
FILTER=""
