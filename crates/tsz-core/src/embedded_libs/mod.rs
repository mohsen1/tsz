...
pub fn get_lib_content(filename: &str) -> Option<&'static str> {
    match filename {
        ...
        "es2025.d.ts" => Some(include_str!("../lib-assets-stripped/es2025.d.ts")),
        "es2025.float16.d.ts" => Some(include_str!("../lib-assets-stripped/es2025.float16.d.ts")),
        "es2025.full.d.ts" => Some(include_str!("../lib-assets-stripped/es2025.full.d.ts")),
        ...
        "es2025.promise.d.ts" => Some(include_str!("../lib-assets-stripped/es2025.promise.d.ts")),
        "es2025.regexp.d.ts" => Some(include_str!("../lib-assets-stripped/es2025.regexp.d.ts")),
...
pub fn get_lib_content_hash(filename: &str) -> Option<u64> {
    match filename {
        ...
        "es2025.d.ts" => embedded_hash_arm!("es2025.d.ts"),
        "es2025.float16.d.ts" => embedded_hash_arm!("es2025.float16.d.ts"),
        "es2025.full.d.ts" => embedded_hash_arm!("es2025.full.d.ts"),
        "es2025.intl.d.ts" => embedded_hash_arm!("es2025.intl.d.ts"),
        "es2025.iterator.d.ts" => embedded_hash_arm!("es2025.iterator.d.ts"),
        "es2025.promise.d.ts" => embedded_hash_arm!("es2025.promise.d.ts"),
        "es2025.regexp.d.ts" => embedded_hash_arm!("es2025.regexp.d.ts"),
...
pub fn get_embedded_lib_references(filename: &str) -> &'static [&'static str] {
    match filename {
        ...
        "es2015.generator.d.ts" | "es2019.object.d.ts" | "es2025.iterator.d.ts" => {
            &["es2015.iterable"]
        }
        ...
        "es2018.asynciterable.d.ts" | "es2025.float16.d.ts" => {
        ...
        "esnext.date.d.ts" | "esnext.intl.d.ts" => &["esnext.temporal"],
