...
pub(super) const PREC_ADDITIVE: u8 = 8;
pub(super) const PREC_MULTIPLICATIVE: u8 = 9;
pub(super) const PREC_UNARY: u8 = 10;
pub(super) const PREC_POSTFIX: u8 = 11;
pub(super) const PREC_PRIMARY: u8 = 12;
