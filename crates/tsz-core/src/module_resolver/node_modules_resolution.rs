...
impl ModuleResolver {
    ...
    pub(super) fn resolve_bare_specifier(
        ...
        match self.try_self_reference_v2(
            ...
            SelfReferenceResultV2::AmbiguousRoot { export_map_entry, package_json_path } => {
    ...
    pub(super) fn resolve_package(
        ...
        // package.json is absent in node_modules. If package.json has an exports field
        // and exports-based resolution is enabled (Node16/NodeNext/Bundler), do not
        // continue fallback resolution, because exports is authoritative there.
        let is_symlinked_package_root = std::fs::symlink_metadata(package_dir)
            .map(|meta| meta.file_type().is_symlink())
            .unwrap_or(false);
        if package_json_path.is_file() || !is_symlinked_package_root {
