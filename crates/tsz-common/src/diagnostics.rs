...
pub mod diagnostic_codes {
    ...
    pub const ABSTRACT_ONLY_IN_ABSTRACT_CLASS: u32 = 1253; // 'abstract' modifier can only appear within an abstract class.
    pub const ABSTRACT_ACCESSOR_CANNOT_HAVE_IMPLEMENTATION: u32 = 1318; // An abstract accessor cannot have an implementation.
    ...
    pub const UNEXPECTED_KEYWORD_OR_IDENTIFIER: u32 = 1434; // Unexpected keyword or identifier.
    pub const UNKNOWN_KEYWORD_OR_IDENTIFIER_DID_YOU_MEAN: u32 = 1435; // Unknown keyword or identifier. Did you mean '{0}'?
    pub const INTERFACE_MUST_BE_GIVEN_A_NAME: u32 = 1438; // Interface must be given a name.
