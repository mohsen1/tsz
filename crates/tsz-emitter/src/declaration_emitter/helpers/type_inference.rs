...
impl<'a> DeclarationEmitter<'a> {
    ...
    fn package_json_name_matches_import_specifier(
        &self,
        module_path: &str,
        module_specifier: &str,
    ) -> bool {
    ...
    fn rewrite_relative_import_type_specifiers(type_text: &str, module_specifier: &str) -> String {
    ...
    fn node_modules_package_contains_import_specifier(
        &self,
        module_path: &str,
        module_specifier: &str,
    ) -> bool {
