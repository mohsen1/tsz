...
impl<'a> DeclarationEmitter<'a> {
    ...
    fn call_receiver_default_import_alias(&self, expr_idx: NodeIndex) -> Option<(String, String)> {
        let expr_idx = self.skip_parenthesized_expression(expr_idx)?;
        let expr_node = self.arena.get(expr_idx)?;
    ...
    fn rewrite_import_type_export_to_default_alias(
        text: &str,
        export_name: &str,
        public_module: &str,
    ) -> String {
    ...
    fn rewrite_call_receiver_default_import_aliases(
        &self,
