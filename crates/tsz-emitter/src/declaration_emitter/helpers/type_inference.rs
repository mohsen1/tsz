...
impl<'a> DeclarationEmitter<'a> {
    ...
    fn type_alias_application_substitutions(
        &self,
    ...
    fn normalize_local_type_literal_accessor_text(type_text: &str) -> String {
        let trimmed = type_text.trim();
    ...
    fn find_enclosing_block_type_alias_declaration(
        &self,
        from_idx: NodeIndex,
        name: &str,
    ) -> Option<NodeIndex> {
