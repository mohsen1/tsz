...
impl<'a> DeclarationEmitter<'a> {
    pub fn new(arena: &'a NodeArena) -> Self {
        DeclarationEmitter {
            ...
            js_cjs_source_exports: FxHashMap::default(),
            js_cjs_export_alias_local_names: FxHashSet::default(),
            js_cjs_export_alias_statements: FxHashSet::default(),
            js_cjs_export_prelude_statements: FxHashSet::default(),
            js_module_exports_object_stmts: FxHashSet::default(),
            js_anonymous_export_equals_dependency_statements: FxHashSet::default(),
            ...
            js_prototype_object_initializers: FxHashMap::default(),
