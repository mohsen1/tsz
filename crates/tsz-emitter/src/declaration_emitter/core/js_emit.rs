...
type JsCjsClosureSecondaryMember = (NodeIndex, NodeIndex, NodeIndex);
type JsCjsExportAssignmentClosure = (NodeIndex, NodeIndex, Vec<JsCjsClosureSecondaryMember>);
...
impl<'a> DeclarationEmitter<'a> {
    ...
    ) -> Option<JsCjsExportAssignmentClosure> {
