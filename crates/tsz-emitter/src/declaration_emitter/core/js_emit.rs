...
impl<'a> DeclarationEmitter<'a> {
    ...
    pub(in crate::declaration_emitter) fn emit_js_function_like_class_if_needed(
        ...
        let anchor_is_function_declaration = self
            .arena
            .get(jsdoc_anchor)
        ...
        if !anchor_is_function_declaration {
            self.write_indent();
    ...
    fn emit_js_function_typed_property(
        &mut self,
        name_idx: NodeIndex,
        initializer: NodeIndex,
    ) -> bool {
    ...
    pub(in crate::declaration_emitter) fn emit_js_class_static_members_namespace(
        ...
        for (member_name, initializer) in members {
                ...
                || init_node.kind == syntax_kind_ext::FUNCTION_EXPRESSION
            {
                ...
                self.emit_js_namespace_value_member(member_name, &type_text);
            }
        }
