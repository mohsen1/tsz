...
fn test_abstract_accessors() {
    let result = emit_dts(r#"
export abstract class AbstractBase {
    abstract get name(): string;
    abstract set name(value: string);
}
"#);
    assert!(result.contains("abstract get name(): string;"), "Missing abstract getter: {}", result);
    assert!(result.contains("abstract set name(value: string);"), "Missing abstract setter: {}", result);
}
...
"#);
    assert!(result.contains("constructor(x: number);"), "Missing first overload: {}", result);
    assert!(result.contains("constructor(x: string, y: number);"), "Missing second overload: {}", result);
    assert!(!result.contains("constructor(x: number | string"), "Implementation should be omitted: {}", result);
}
...
"#);
    assert!(result.contains("Record<string, unknown>"), "Missing constraint: {}", result);
    assert!(result.contains("Record<string, any>"), "Missing default: {}", result);
    assert!(result.contains("keyof T"), "Missing keyof constraint: {}", result);
}
...
"#);
    assert!(result.contains("(): void"), "Missing first call sig: {}", result);
    assert!(result.contains("(x: number): number"), "Missing second call sig: {}", result);
    assert!(result.contains("name: string"), "Missing property: {}", result);
}
...
"#);
    assert!(result.contains("Tree<T>[]"), "Missing recursive ref: {}", result);
}
...
"#);
    assert!(result.contains("const enum Color"), "Missing const enum: {}", result);
...
"#);
    assert!(result.contains("[key: string]: any;"), "Missing index sig: {}", result);
}
...
"#);
    ...
    assert!(result.contains("readonly x: number"), "Missing readonly property: {}", result);
}
...
"#);
    ...
    assert!(result.contains("Promise<infer U>"), "Missing Promise<infer U>: {}", result);
}
...
"#);
    assert!(result.contains("declare module \"express\""), "Missing module augmentation: {}", result);
    assert!(result.contains("userId?"), "Missing augmented property: {}", result);
}
...
"#);
    assert!(result.contains("declare global"), "Missing global augmentation: {}", result);
    assert!(result.contains("customProp: number"), "Missing global property: {}", result);
}
...
"#);
    assert!(result.contains("readonly ["), "Missing readonly tuple: {}", result);
    assert!(result.contains("first: string"), "Missing labeled element: {}", result);
    assert!(result.contains("...rest: number[]"), "Missing rest element: {}", result);
}
...
"#);
    assert!(result.contains("${T}"), "Missing template literal type: {}", result);
}
...
"#);
    assert!(result.contains("import(\"fs\")"), "Missing import type: {}", result);
}
...
"#);
    assert!(result.contains("namespace Shapes"), "Missing namespace: {}", result);
    assert!(result.contains("class Circle"), "Missing class: {}", result);
    assert!(result.contains("interface Circle"), "Missing interface: {}", result);
}
...
"#);
    assert!(result.contains("[Symbol.iterator]"), "Missing Symbol.iterator: {}", result);
    assert!(result.contains("Iterator<number>"), "Missing return type: {}", result);
}
...
"#);
    assert!(result.contains("get value(): number;"), "Missing getter: {}", result);
    assert!(!result.contains("set value"), "Should not have setter: {}", result);
}
...
"#);
    assert!(result.contains("setName(name: string): this;"), "Missing this return type: {}", result);
}
...
"#);
    assert!(result.contains("as `on${Capitalize<K>}`"), "Missing as clause with template: {}", result);
}
...
"#);
    assert!(result.contains("abstract transform<U>(input: T): U;"), "Missing abstract generic method: {}", result);
}
...
"#);
    let expected = "export declare const enum Color {\n    Red = 1,\n    Green = 2,\n    Blue = 4\n}\n";
    assert_eq!(result, expected, "Mismatch with tsc");
}
...
"#);
    let expected = "export interface Constructor<T> {\n    new (...args: any[]): T;\n    prototype: T;\n}\n";
    assert_eq!(result, expected, "Mismatch with tsc");
}
...
"#);
    let expected = "export declare enum NegativeEnum {\n    A = -1,\n    B = -2,\n    C = -100\n}\n";
    assert_eq!(result, expected, "Mismatch with tsc");
}
...
"#);
    let expected = "export interface NumberKeyed {\n    0: string;\n    1: number;\n    2: boolean;\n}\n";
    assert_eq!(result, expected, "Mismatch with tsc");
}
...
"#);
    let expected = "export declare enum StringKeys {\n    \"hello world\" = 0,\n    \"foo-bar\" = 1\n}\n";
    assert_eq!(result, expected, "Mismatch with tsc");
}
...
"#);
    let expected = "export type NamedTuple = [first: string, second?: number, ...rest: boolean[]];\n";
    assert_eq!(result, expected, "Mismatch with tsc");
}
