...
impl<'a> LoweringPass<'a> {
    ...
    fn class_has_private_members(&self, class_data: &tsz_parser::parser::node::ClassData) -> bool {
    ...
    fn get_block_like(&self, node: &Node) -> Option<&tsz_parser::parser::node::BlockData> {
