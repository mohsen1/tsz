...
impl<'a> Printer<'a> {
    ...
    fn emit_property_access_commented_dot(
        &mut self,
    ...
    fn emit_property_access_compact_comments(
        &mut self,
        start_pos: u32,
        end_pos: u32,
    ...
    fn source_range_has_newline_local(&self, start: u32, end: u32) -> bool {
        let Some(text) = self.source_text else {
            return false;
        };
    ...
    fn emit_optional_chain_inline_gap_comments_untracked(&mut self, start_pos: u32, dot_pos: u32) {
    ...
    fn emit_optional_property_access_downlevel_suffix(
        &mut self,
        access: &AccessExprData,
        expr_node: &Node,
        name_node: &Node,
