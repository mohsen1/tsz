...
pub struct BinderState {
    ...
    /// This allows second pass of `merge_bind_results` to find the first pass global ID for each
    ...
    // ===== DefId-First Stable Identity (first pass) =====
    ...
    ///
    /// This is the binder's contribution to stable semantic identity (first pass).
