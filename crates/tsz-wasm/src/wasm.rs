...
use tsz::tsz_solver::construction::TypeInterner;
...
impl WasmTypeInterner {
    ...
    pub fn resolve_atom(&self, atom_id: u32) -> String {
        self.inner.resolve_atom(tsz::interner::Atom(atom_id))
    }
}
...
impl WasmParallelParser {
    ...
    pub fn parse_all(&mut self) -> JsValue {
        ...
        let result = panic::catch_unwind(panic::AssertUnwindSafe(|| {
            let (_results, stats) = tsz::parallel::parse_files_with_stats(files);
...
impl WasmParallelChecker {
    ...
    pub fn check_all(&mut self) -> JsValue {
        ...
        let result = panic::catch_unwind(panic::AssertUnwindSafe(|| {
            ...
            // Check in parallel
            let (result, stats) = tsz::parallel::check_functions_with_stats(&program);
