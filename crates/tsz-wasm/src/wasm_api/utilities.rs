...
///
/// Returns a JSON array of tokens, each with `kind`, `text`, `start`, and
/// `end` fields. Trivia (whitespace, comments) is skipped, matching the
/// default behavior of the TypeScript scanner.
