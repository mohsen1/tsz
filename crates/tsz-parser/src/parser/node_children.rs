...
use super::syntax_kind_ext::{
    ...
    TEMPLATE_LITERAL_TYPE_SPAN, TEMPLATE_SPAN, THROW_STATEMENT, TRY_STATEMENT, TUPLE_TYPE,
    TYPE_ALIAS_DECLARATION, TYPE_ASSERTION, TYPE_LITERAL, TYPE_OPERATOR, TYPE_PARAMETER,
    TYPE_PREDICATE, TYPE_QUERY, TYPE_REFERENCE, UNION_TYPE, VARIABLE_DECLARATION,
    VARIABLE_DECLARATION_LIST, VARIABLE_STATEMENT, WHILE_STATEMENT, WITH_STATEMENT,
    YIELD_EXPRESSION,
};
