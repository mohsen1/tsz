...
impl NodeArena {
    #[inline]
    fn add_opt_child(children: &mut Vec<NodeIndex>, idx: NodeIndex) {
        if idx.is_some() {
            children.push(idx);
        }
    }
    ...
    #[inline]
    fn add_list(children: &mut Vec<NodeIndex>, list: &NodeList) {
        children.extend(list.nodes.iter().copied());
    }

    #[inline]
    fn add_opt_list(children: &mut Vec<NodeIndex>, list: Option<&NodeList>) {
        if let Some(l) = list {
            children.extend(l.nodes.iter().copied());
        }
    }

    fn collect_name_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
            QUALIFIED_NAME => {
    ...
    fn collect_expression_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
            BINARY_EXPRESSION => {
    ...
    fn collect_statement_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
            VARIABLE_STATEMENT => {
    ...
    fn collect_declaration_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
            FUNCTION_DECLARATION => {
                if let Some(data) = self.get_function(node) {
                    Self::add_opt_list(children, data.modifiers.as_ref());
    ...
    fn collect_import_export_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
    ...
    fn collect_type_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
            TYPE_REFERENCE => {
    ...
    fn collect_member_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
    ...
    fn collect_pattern_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
    ...
    fn collect_jsx_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
            JSX_ELEMENT => {
    ...
    fn collect_signature_children(&self, node: &Node, children: &mut Vec<NodeIndex>) -> bool {
        match node.kind {
