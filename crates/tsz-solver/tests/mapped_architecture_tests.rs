...
// =============================================================================
// expand_mapped_type_to_properties_with_resolver tests
// =============================================================================

#[test]
fn expand_with_resolver_produces_same_result_for_simple_types() {
    use crate::TypeEnvironment;
    use crate::type_queries::expand_mapped_type_to_properties_with_resolver;
    ...
    // Resolver-aware version should produce same result as no-resolver for simple templates
    let props = expand_mapped_type_to_properties_with_resolver(
        &interner,
        &resolver,
        &mapped,
        &keys,
...
#[test]
fn expand_with_resolver_homomorphic_preserves_declared_type() {
    use crate::TypeEnvironment;
    use crate::type_queries::expand_mapped_type_to_properties_with_resolver;
