...
impl<'a> TypeFormatter<'a> {
    ...
    /// (`tree: any`), matching tsc. Delegates to the interner's
    /// `display_params_for_function_shape`, the single owner of the mask
    /// semantics shared with declaration-emit printing.
    pub(super) fn display_params_for_function_shape<'p>(
        ...
        self.interner
            .display_params_for_function_shape(shape_id, params)
    }
