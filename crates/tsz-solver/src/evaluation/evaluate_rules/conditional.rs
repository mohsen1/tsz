...
impl<'a, R: TypeResolver> TypeEvaluator<'a, R> {
    ...
    /// iteration.
    fn resolve_operands(&mut self, cond: &ConditionalType) -> ConditionalOperands {
    ...
    fn check_conditional_subtype(&mut self, check_type: TypeId, extends_type: TypeId) -> bool {
