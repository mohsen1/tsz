...
pub use crate::type_queries_extended::{
    ...
    get_boolean_literal_value, get_callable_type_param_count, get_invalid_index_type_member,
    get_literal_property_name, get_number_literal_value, get_string_literal_atom,
