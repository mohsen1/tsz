...
pub use crate::type_queries_extended::{
    ...
    BaseInstanceMergeKind, CallSignaturesKind, ClassDeclTypeKind, ConstructorAccessKind,
    ConstructorCheckKind, ConstructorReturnMergeKind, ContextualLiteralAllowKind,
    ElementIndexableKind, ExcessPropertiesKind, IndexKeyKind, InstanceTypeKind, KeyOfTypeKind,
    LazyTypeKind, LiteralKeyKind, LiteralTypeKind, MappedConstraintKind, NamespaceMemberKind,
    PrivateBrandKind, PromiseTypeKind, PropertyAccessResolutionKind, StringLiteralKeyKind,
    ...
    classify_for_assignability_eval, classify_for_base_instance_merge,
    classify_for_call_signatures, classify_for_class_decl, classify_for_constructor_access,
    classify_for_constructor_check, classify_for_constructor_return_merge,
    classify_for_contextual_literal, classify_for_excess_properties, classify_for_instance_type,
    ...
    get_mapped_type_id, get_number_literal_value, get_string_literal_atom,
    get_string_literal_value, get_tuple_list_id, get_type_param_default, get_widened_literal_type,
    is_boolean_literal, is_direct_type_parameter, is_invalid_index_type, is_number_literal,
    is_object_with_index_type, is_string_literal, unwrap_readonly_for_lookup,
