...
pub use extended::{
    ...
    TypeArgumentExtractionKind, TypeQueryKind, TypeResolutionKind, classify_array_like,
    classify_element_indexable, classify_for_call_signatures, classify_for_contextual_literal,
    classify_for_lazy_resolution, classify_for_property_access_resolution,
    ...
    classify_type_query, create_number_literal_type, create_string_literal_type,
    get_application_base, get_invalid_index_type_member, get_literal_property_name,
