...
pub use extended::{
    ...
    get_number_literal_value, get_string_literal_value, get_tuple_list_id, is_composite_shape_type,
    is_literal_enum_member, is_number_literal, is_object_with_index_type, is_string_literal,
    key_matches_number_index, key_matches_string_index, type_contains_string_literal,
