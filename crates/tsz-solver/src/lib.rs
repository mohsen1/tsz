...
pub use visitors::visitor::{
    ...
    contains_this_type, contains_type_by_id, contains_type_matching, contains_type_parameter_named,
    contains_type_parameters, enum_components, for_each_child, for_each_child_by_id,
    function_shape_id, has_deferred_conditional_member, index_access_parts, intersection_list_id,
