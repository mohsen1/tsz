...
//! rules from the catalog references used in this workspace against the actual solver implementation.
//!
//! ## Audit Matrix
//!
...
impl UnsoundnessAudit {
    ...
    pub fn new() -> Self {
        ...
        rules.insert(1, RuleImplementation {
            ...
            implementation_files: vec!["src/relations/lawyer.rs", "src/relations/compat.rs"],
            test_coverage: 0.95,
            dependencies: vec![],
        ...
        rules.insert(20, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase1,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/compat.rs", "src/relations/subtype/core.rs"],
            test_coverage: 0.85,
            dependencies: vec![12],
        ...
        rules.insert(6, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase1,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/core.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(11, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase1,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/intern/mod.rs", "src/relations/compat.rs", "src/relations/subtype/core.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(2, RuleImplementation {
            ...
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/core.rs", "src/relations/subtype/rules/functions/mod.rs", "src/types.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(4, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase2,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/lawyer.rs", "crates/tsz-checker/src/state/state.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(10, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase2,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/rules/literals.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(19, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase2,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/core.rs", "src/relations/subtype/rules/functions/mod.rs"],
            test_coverage: 0.80,
            dependencies: vec![],
        ...
        rules.insert(25, RuleImplementation {
            ...
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/rules/objects.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(40, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase3,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/lawyer.rs", "src/evaluation/evaluate_rules/conditional.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(30, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase3,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate.rs", "src/evaluation/evaluate_rules/keyof.rs", "src/relations/subtype/core.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(21, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase3,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate.rs", "src/intern/mod.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(41, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase3,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate_rules/mapped.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(5, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["crates/tsz-checker/src/types/class_type/core.rs", "src/relations/compat.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(18, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["crates/tsz-checker/src/types/class_type/core.rs"],
            test_coverage: 0.80,
            dependencies: vec![],
        ...
        rules.insert(43, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["crates/tsz-checker/src/types/class_type/core.rs", "crates/tsz-checker/src/state/state.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(39, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["crates/tsz-checker/src/query_boundaries/type_checking.rs", "crates/tsz-checker/src/query_boundaries/type_computation/core.rs", "crates/tsz-checker/src/symbols/symbol_resolver.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(13, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/compat.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(15, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/core.rs", "src/relations/subtype/rules/tuples.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(16, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/core.rs", "src/relations/compat.rs", "src/evaluation/evaluate_rules/conditional.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(22, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/intern/mod.rs", "src/intern/template.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(23, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/intern/mod.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(26, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/types.rs", "src/relations/subtype/rules/objects.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(27, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate_rules/keyof.rs", "src/evaluation/evaluate_rules/apparent.rs", "src/evaluation/evaluate_rules/mapped.rs"],
            test_coverage: 0.85,
            dependencies: vec![12],
        ...
        rules.insert(28, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/rules/functions/mod.rs"],
            test_coverage: 0.85,
            dependencies: vec![6],
        ...
        rules.insert(29, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/core.rs", "src/relations/subtype/rules/intrinsics.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(32, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/inference/infer.rs", "crates/tsz-checker/src/query_boundaries/type_computation/core.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(38, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate_rules/index_access.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(42, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["crates/tsz-checker/src/flow/control_flow/core.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(12, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate_rules/apparent.rs", "src/relations/subtype/core.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
