...
impl UnsoundnessAudit {
    ...
    pub fn new() -> Self {
        ...
        rules.insert(20, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase1,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/compat.rs", "src/relations/subtype/mod.rs"],
            test_coverage: 0.85,
            dependencies: vec![12],
        ...
        rules.insert(6, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase1,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/mod.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(11, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase1,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/intern/mod.rs", "src/relations/compat.rs", "src/relations/subtype/mod.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(2, RuleImplementation {
            ...
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/mod.rs", "src/relations/subtype/rules/functions/mod.rs", "src/types.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(19, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase2,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/mod.rs", "src/relations/subtype/rules/functions/mod.rs"],
            test_coverage: 0.80,
            dependencies: vec![],
        ...
        rules.insert(40, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase3,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate.rs", "src/evaluation/evaluate_rules/conditional.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(30, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase3,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/evaluation/evaluate.rs", "src/evaluation/evaluate_rules/keyof.rs", "src/relations/subtype/mod.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(5, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["crates/tsz-checker/src/classes/private_checker.rs", "src/relations/compat.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(15, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/mod.rs", "src/relations/subtype/rules/tuples.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(16, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/mod.rs", "src/relations/compat.rs", "src/evaluation/evaluate_rules/conditional.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(22, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/intern/mod.rs", "src/evaluation/evaluate_rules/template_literal.rs"],
            test_coverage: 0.90,
            dependencies: vec![],
        ...
        rules.insert(29, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/relations/subtype/mod.rs", "src/relations/subtype/rules/intrinsics.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(32, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/inference/infer.rs", "crates/tsz-checker/src/types/computation"],
            test_coverage: 0.85,
            dependencies: vec![],
        ...
        rules.insert(12, RuleImplementation {
            ...
            phase: ImplementationPhase::Phase4,
            status: ImplementationStatus::FullyImplemented,
            implementation_files: vec!["src/objects/apparent.rs", "src/evaluation/evaluate_rules/apparent.rs", "src/relations/subtype/mod.rs"],
            test_coverage: 0.85,
            dependencies: vec![],
