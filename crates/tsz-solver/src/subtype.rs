...
use crate::types::{
    ...
    ObjectFlags, ObjectShape, ObjectShapeId, RelationCacheKey, StringIntrinsicKind, SymbolRef,
    TupleListId, TypeApplicationId, TypeData, TypeId, TypeListId, TypeParamInfo, Visibility,
};
use crate::visitor::{
...
impl<'a, R: TypeResolver> SubtypeChecker<'a, R> {
    ...
    fn check_generic_index_access_subtype(&mut self, source: TypeId, target: TypeId) -> bool {
