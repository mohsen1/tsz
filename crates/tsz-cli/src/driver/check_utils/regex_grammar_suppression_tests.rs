...
fn regex_validator_diagnostic_surface_is_audited() {
    ...
    const AUDITED_REGEX_ONLY: &[&str] = &[
        ...
        "THIS_BACKREFERENCE_REFERS_TO_A_GROUP_THAT_DOES_NOT_EXIST_THERE_ARE_ONLY_CAPTURING_GROUPS_IN_THIS_REGULAR_EXPRESSION",
        ...
        "OCTAL_ESCAPE_SEQUENCES_AND_BACKREFERENCES_ARE_NOT_ALLOWED_IN_A_CHARACTER_CLASS_IF_THIS_WAS_INTENDED_AS_AN_ESCAPE_SEQUENCE_USE_THE_SYNTAX_INSTEAD",
