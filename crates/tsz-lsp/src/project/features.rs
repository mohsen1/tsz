...
use crate::diagnostics::{
    ...
    LspDiagnostic, UnchangedDocumentDiagnosticReport, WorkspaceDiagnosticReport,
    WorkspaceDiagnosticReportItem,
};
...
impl Project {
    ...
    fn diagnostics_cache_valid(&self, file_name: &str) -> bool {
