...
pub(super) const OBJECT_PROTOTYPE_ONLY_MEMBERS: &[&str] = &[
    "constructor",
    "hasOwnProperty",
    "isPrototypeOf",
...
pub(super) fn primitive_member_is_completion_eligible(kind: IntrinsicKind, name: &str) -> bool {
    if !matches!(
        kind,
...
pub(super) fn dot_access_member_label_is_completion_eligible(name: &str) -> bool {
