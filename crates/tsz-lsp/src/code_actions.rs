...
use tsz_binder::{ScopeId, SymbolId, symbol_flags};
...
impl<'a> CodeActionProvider<'a> {
    ...
    fn import_decl_range(&self, node: &tsz_parser::parser::node::Node) -> (Range, String) {
        let mut end = node.end;
    ...
    fn find_closing_brace_offset(&self, node: &tsz_parser::parser::node::Node) -> Option<u32> {
