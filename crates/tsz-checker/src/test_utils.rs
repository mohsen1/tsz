...
/// Combined parser+checker parse-health helpers. Extracted to
/// [`parse_health`] to keep this module under the file-size cap (§19);
/// re-exported so existing call sites are unchanged.
mod parse_health;
pub use parse_health::{
    check_source_codes_with_parse_health, check_source_codes_with_parse_health_and_options,
    check_source_with_parse_health, check_source_with_parse_health_and_options,
};
