...
impl<'a> CheckerState<'a> {
    ...
    pub fn judge_classify_iterable(&self, type_id: TypeId) -> tsz_solver::judge::IterableKind {
    ...
    pub fn judge_classify_callable(&self, type_id: TypeId) -> tsz_solver::judge::CallableKind {
    ...
    ) -> tsz_solver::judge::PropertyResult {
    ...
    pub fn judge_classify_truthiness(&self, type_id: TypeId) -> tsz_solver::judge::TruthinessKind {
    ...
    pub fn judge_classify_primitive(&self, type_id: TypeId) -> tsz_solver::judge::PrimitiveFlags {
