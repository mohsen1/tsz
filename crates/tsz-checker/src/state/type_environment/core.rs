...
impl<'a> CheckerState<'a> {
    ...
    pub(crate) fn evaluate_application_type_inner(&mut self, type_id: TypeId) -> TypeId {
        ...
        // match at the Application level (e.g., `Synthetic<number, number>` vs
        // `Synthetic<T, infer V>`). Without this, Application args get evaluated
        // to structural Object forms, destroying the type identity needed for
        // declaration-level infer matching.
