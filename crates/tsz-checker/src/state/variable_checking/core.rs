...
impl<'a> CheckerState<'a> {
    ...
    pub(crate) fn check_variable_declaration_with_request(
        ...
        // parser (`report_const_or_using_uninitialized`,
        // `state_variable_declarations.rs`), not here — #17251 moved the
        // check there and this checker-side copy was left behind, double-
        // emitting the diagnostic for every uninitialized const/using
        // binding (#17253).
