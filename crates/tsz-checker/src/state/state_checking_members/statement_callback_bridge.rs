    ...
    fn check_function_declaration(&mut self, func_idx: NodeIndex) {
        ...
        if func.body.is_some() {
            ...
            if func.is_async && !func.asterisk_token && has_type_annotation {
                // Check the pre-evaluation return type (not evaluate_application_type
                // which flattens to Object shapes and loses Promise identity).
                // The is_global_promise_type check handles type aliases like
