...
impl<'a> CheckerState<'a> {
    ...
    fn source_file_type_node_is_option_bag_lowerable<'b>(
        ...
        if super::source_file_direct_lowerability::is_scope_independent(arena, node_idx) {
            return true;
        }
        if node_idx.is_none() {
            return false;
    ...
    fn direct_lower_source_file_annotation_type(
        ...
        if super::source_file_direct_lowerability::is_scope_independent(symbol_arena, annotation) {
    ...
    pub(crate) fn direct_source_file_type_alias_result(
        ...
        let type_param_names = super::source_file_direct_lowerability::type_alias_type_param_names(
            symbol_arena,
            type_alias,
        );
