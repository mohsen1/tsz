...
//!
//! This module contains the typed cross-file query bucket discriminant plus
//! the remaining two types from the plan's API contract:
//!
...
/// targets. Replaces the four `u8` constants that used to live in
/// `cross_file.rs`, matching the API shape proposed in
/// `docs/plan/PERFORMANCE_PLAN.md` §7 ("Typed Cross-File Queries"):
///
