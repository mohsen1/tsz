...
impl<'a> CheckerState<'a> {
    ...
    fn get_type_of_symbol_inner(&mut self, sym_id: SymbolId) -> TypeId {
        ...
        {
            // Class symbols gate the SYMBOL-bucket shortcut on the instance
            // side being recoverable; see `class_instance_recoverable`
            // (#13185).
            ...
            if !symbol_is_class || self.ctx.class_instance_recoverable(sym_id, file_idx as u32) {
                return cached;
            }
        }
