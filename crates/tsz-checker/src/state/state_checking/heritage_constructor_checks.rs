//! Constructor-compatibility, before-declaration, and type-parameter-reference
//! heritage checks split out of `heritage.rs` to keep each module under the
//! checker boundary line cap.
