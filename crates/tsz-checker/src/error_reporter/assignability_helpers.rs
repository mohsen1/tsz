...
impl<'a> CheckerState<'a> {
    ...
    pub(crate) fn error_type_not_assignable_at_with_display_types(
        ...
        let source_str =
            self.format_assignability_type_for_message(source_for_display, target_for_display);
        let target_str =
            self.format_assignability_type_for_message(target_for_display, source_for_display);
