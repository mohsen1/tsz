...
impl<'a> CheckerState<'a> {
    ...
    pub(super) fn render_missing_property(
        ...
        let widened_source = self.widen_type_for_display_preserving_non_fresh(source_type);
    ...
    pub(super) fn render_missing_properties(
        ...
        let src_str = if depth == 0 {
            ...
            let widened_source = self.widen_type_for_display_preserving_non_fresh(display_source);
