//! JSX union-prop attribute collection helpers.
...
impl<'a> CheckerState<'a> {
    pub(super) fn collect_jsx_union_resolution_attr_value_type(
        &mut self,
        value_idx: NodeIndex,
    ...
    pub(super) fn collect_jsx_union_resolution_spread_attrs(
        &mut self,
        expr_idx: NodeIndex,
