...
impl<'a> CheckerContext<'a> {
    ...
    fn base(
        ...
        CheckerContext {
            ...
            symbol_nested_closure_assignment: RefCell::new(FxHashMap::default()),
            symbol_has_non_initializer_assignment: RefCell::new(FxHashMap::default()),
            symbol_first_identifier_ref: RefCell::new(FxHashMap::default()),
