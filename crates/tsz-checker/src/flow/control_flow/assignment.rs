...
use crate::query_boundaries::flow_analysis::{
    PropertyAccessResult, array_type, fallback_compound_assignment_result, flow_tuple_element,
    get_array_element_type, is_assignment_operator as boundary_is_assignment_operator,
    is_compound_assignment_operator, is_logical_compound_assignment_operator,
    map_compound_assignment_to_binary, new_binary_op_evaluator, tuple_elements_for_type,
...
impl<'a> FlowAnalyzer<'a> {
    ...
    fn destructuring_tuple_type_from_array_literal(
        ...
        for &element in &literal.elements.nodes {
            ...
            tuple_elements.push(flow_tuple_element(ty));
        }
