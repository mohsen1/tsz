...
pub(crate) use super::containment_queries::{
    ...
    contains_type_parameter_named, contains_type_parameters,
    contains_unknown_at_instantiation_positions, has_deferred_conditional_member,
...
pub(crate) use super::shape_predicates::{
    ...
    is_conditional_type, is_constructor_like_type, is_deferred_constraint_relative_operand,
    is_definitely_nullish, is_distributive_conditional_with_deferred_check, is_empty_object_type,
    is_enum_type, is_error_type, is_evaluable_meta_type, is_fresh_object_type, is_function_type,
