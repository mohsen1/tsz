...
pub(crate) use super::common::{
    ...
    intersection_members, is_symbol_or_unique_symbol, is_template_literal_type,
    is_type_parameter_like, lazy_def_id, literal_value, no_infer_inner_type, object_shape_for_type,
    union_list_id, union_members, widen_literal_to_primitive,
};
