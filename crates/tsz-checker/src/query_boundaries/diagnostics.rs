...
pub(crate) use super::common::{
    ...
    is_intersection_type, is_number_literal, is_symbol_or_unique_symbol, is_template_literal_type,
    keyof_inner_type, lazy_def_id, literal_value, mapped_type_id, mapped_type_info,
