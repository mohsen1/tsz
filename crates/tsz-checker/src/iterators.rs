...
impl<'a, 'ctx> IteratorChecker<'a, 'ctx> {
    ...
    fn create_structural_iterator_type(&self, element_type: TypeId) -> TypeId {
        ...
        let next_method_shape = tsz_solver::FunctionShape {
            type_params: Vec::new(),
            params: Vec::new(),
            this_type: None,
        ...
        let next_property = tsz_solver::PropertyInfo {
            name: next_atom,
    ...
    fn object_has_async_iterator_method(&self, shape_id: tsz_solver::ObjectShapeId) -> bool {
    ...
    fn is_valid_for_in_target(&self, type_id: TypeId) -> bool {
        ...
        tsz_solver::type_queries::is_valid_for_in_target(self.ctx.types, type_id)
    }
