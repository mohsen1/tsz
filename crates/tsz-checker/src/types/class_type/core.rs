...
use super::core_heritage_merge::{ClassInstanceMembers, HeritageCycleGuard};
use super::helpers::{AccessorAggregate, MethodAggregate, exceeds_class_inheritance_depth_limit};
...
impl<'a> CheckerState<'a> {
    ...
    pub(crate) fn get_class_instance_type_inner(
        ...
        // Merge base-class instance members and any merged interface
        // declarations into `properties`/index signatures. Extracted to
        // core_heritage_merge.rs to keep this file under the line cap.
        if let Some(early_return) = self.merge_class_heritage_and_interfaces(
            class,
            class_idx,
            current_sym,
            HeritageCycleGuard {
            ...
            ClassInstanceMembers {
                ...
                number_index: &mut number_index,
                merged_interface_type_for_class: &mut merged_interface_type_for_class,
            },
        ) {
            return early_return;
        }
