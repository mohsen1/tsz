...
#[test]
#[ignore = "pending: needs tsc-compatible widened keyof array element display"]
...
#[test]
#[ignore = "pending: keyof type alias caching bug - function parameter processing corrupts keyof evaluation"]
