...
#[test]
#[ignore = "pending: needs nested property mismatch to preserve qualified related TS2345"]
...
#[test]
#[ignore = "pending: needs tsc-compatible failed generic-call inference to also surface TS2403"]
