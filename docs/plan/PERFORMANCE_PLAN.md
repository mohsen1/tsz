...
**2026-05-14 PropertyKey alias follow-up (main-based):** a narrow follow-up
admits `PropertyKey` in the direct actual-lib alias-body allowlist. On
monorepo-006 (latest `main` baseline) this drops
`DelegateCrossArenaSymbol` children from 22 to 21, `delegate.misses` from 24
to 23, and `checker.with_parent_cache_constructed` from 25 to 24 with
unchanged diagnostics (`10,198`). Declaration-file residue row removed:
`PropertyKey`. Decision record:
[`perf-runs/2026-05-14-delegate-actual-lib-property-key-main.md`](perf-runs/2026-05-14-delegate-actual-lib-property-key-main.md).
Claim:
[`claims/perf-delegate-actual-lib-property-key-main-2026-05-14.md`](claims/perf-delegate-actual-lib-property-key-main-2026-05-14.md).
