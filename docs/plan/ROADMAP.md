...
- **2026-05-06** · branch `fix/js-emit-next-122` · **Workstream-4 / architecture-health-metric-1 cap bump** · `CheckerContext` field count cap 226 → 227 for the current branch state after the recovered module-helper emitter work. This is an intentional guard bump for the CI lint gate; follow-up work should reduce the metric rather than grow it further.
