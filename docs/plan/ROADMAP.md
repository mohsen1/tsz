...
- **2026-04-26** · branch `chore/dashboard-track-ts1005-ts2353` · **Workstream-1 claim** · Workstream 1 near-term priorities → 5: "Track top-code deltas for TS2322, TS2345, TS2339, TS1005, and TS2353." The KPI dashboard in `scripts/conformance/query-conformance.py` currently tracks only TS2322/TS2339/TS2345 in KPI 1. Add TS1005 (parser recovery) and TS2353 (excess properties) as a KPI 1b "Other tracked codes" block so all 5 codes from the roadmap have visible deltas. No production change. Draft PR: `[WIP] chore(scripts/conformance): track TS1005 + TS2353 in KPI dashboard`.
