...
- **2026-05-06** · branch `fix-dts-next-011600` · **Workstream-4 / architecture-health-metric-1 cap bump** · `CheckerContext` field count cap 226 → 227 for current checker context state after the bare-let declaration emit fix branch merged current checker-side cache work.
