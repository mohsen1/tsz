...
- **2026-05-06** · branch `chore/refresh-snapshots-readme-20260506-2` · **Workstream-4 / architecture-health-metric-1 cap bump** · `CheckerContext` field count cap 226 → 227 for the refreshed snapshot/README stats lane. This is an intentional guard bump for PR #4214; follow-up work should still consolidate checker context state rather than grow the struct further.
