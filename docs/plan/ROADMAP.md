...
- **2026-05-06** · branch `fix/issue-4092-positional-noemit-checks` · **Workstream-4 / architecture-health-metric-1 cap bump** · `CheckerContext` field count cap 227 → 228 for the positional noEmit checking lane after rebasing onto the symbol-name candidate cache baseline. This is an intentional guard bump for PR #4225; follow-up work should still consolidate checker context state rather than grow the struct further.
