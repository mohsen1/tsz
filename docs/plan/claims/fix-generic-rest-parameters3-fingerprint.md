...
- `cargo nextest run -p tsz-solver diagnostics::format::tests::format_function_type_param_with_structural_array_constraint_uses_shorthand diagnostics::format::tests::format_function_type_param_with_array_application_constraint_preserves_generic_form diagnostics::format::tests::format_function_type_param_with_constraint`
