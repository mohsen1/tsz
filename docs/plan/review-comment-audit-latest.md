...
- PRs scanned: 500
- PRs excluded as already followed-up: 82
...
- [#5081](https://github.com/mohsen1/tsz/pull/5081) fix(checker): contextually type empty arrays in logical OR: 1
- [#5086](https://github.com/mohsen1/tsz/pull/5086) fix(binder): guard persistent scope count overflow with better error message: 1
