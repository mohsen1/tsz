...
**Conformance: 51 → 46 failing tests** (-5 tests)

**Investigations (Deferred):**
- test_contextual_property_type_infers_callback_param - Contextual typing complexity
- test_numeric_enum_open_and_nominal_assignability - Assignability checking
- TS2540 readonly properties - TypeKey::Lazy handling (architectural blocker)

**Final Status:**
- 46 failing tests remaining
