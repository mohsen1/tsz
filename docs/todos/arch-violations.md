...
58. **Disconnected module: `decorators.rs`** (335 LOC, 3 pub fns) — `check_decorator`, `check_class_decorators`, `get_decorator_info` have zero callers anywhere in the project. Not wired into dispatch pipeline.
