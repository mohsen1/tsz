...
- **2026-04-25** · branch `claude/modest-archimedes-f5N6i` · **SHIPPED** → PR #1173 · audit §tsz-checker CommonJS export LHS classification · extract `classify_commonjs_lhs` private static helper; replace duplicate 100-line blocks in `collect_future_commonjs_assignment_candidates` and `collect_prior_commonjs_assignment_candidate`; 7 unit tests; files: `crates/tsz-checker/src/state/type_analysis/computed_commonjs/exports_collection.rs`
