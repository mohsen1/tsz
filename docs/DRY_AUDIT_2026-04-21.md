...
- `Symbol::has_any_flags(mask)` sweep across `tsz-checker` — migrated file-by-file: `types/queries/type_only.rs` (#850), `symbols/symbol_resolver_utils.rs` (#853), `state/state_checking/heritage.rs` (#856), `state/type_analysis/core.rs` (#858), `symbols/symbol_resolver.rs` (#863), `flow/flow_analysis/tdz.rs` (#867), `types/property_access_type/resolve.rs` (#873), `types/computation/complex_new_target.rs` (#877), `symbols/symbol_resolver_qualified.rs` (#881), `assignability/assignment_checker/commonjs_assignment.rs` (#883), `context/resolver.rs` (#884), `flow/control_flow/narrowing.rs` (#885), `assignability/assignment_checker/assignment_ops.rs` (#886), and `error_reporter/properties.rs` (current branch).
- `Symbol::all_declarations()` helper on `tsz-binder` (with 8 unit tests), routed through ~20 manual `value_declaration + declarations` collection sites: `checkers/jsx/diagnostics.rs` (×5), `checkers/jsx/children.rs`, `checkers/jsx/props/validation.rs`, `checkers/jsx/orchestration/component_props.rs` (×2), `state/type_environment/core.rs` (×2), `checkers/generic_checker/constraint_validation.rs`, `state/variable_checking/variable_helpers/declaration_emit.rs` (×4), `state/state_checking_members/member_access.rs` (×2), `state/type_analysis/computed_alias.rs`, `state/type_analysis/cross_file.rs`, `state/state_checking/source_file.rs`, `state/type_resolution/module.rs`, `types/type_node_resolution.rs` (×2), `types/queries/callable_truthiness.rs`, `declarations/import/core/helpers.rs`, `declarations/import/core/import_members.rs`, `context/module_entity.rs`, `types/property_access_helpers/expando.rs`, `classes/class_abstract_checker.rs`, `tsz-binder/src/state/core.rs` (×2), `tsz-emitter/src/declaration_emitter/usage_analyzer.rs`, `tsz-lsp/src/signature_help.rs` (×2). Collapses ~150 LOC across binder, checker, emitter, and LSP onto a single deduplicating helper that returns `value_declaration` first followed by remaining declarations (current branch).
