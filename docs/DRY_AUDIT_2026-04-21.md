...
- `Symbol::has_any_flags` sweep across `tsz-checker` — migrated raw `(sym.flags & mask) != 0` idioms in `types/queries/type_only.rs` (#850), `symbols/symbol_resolver_utils.rs` (#853), `state/state_checking/heritage.rs` (#856), `state/type_analysis/core.rs` (#858), `symbols/symbol_resolver.rs` (#863), and `flow/flow_analysis/tdz.rs` (current branch).
