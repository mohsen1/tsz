...
- **2026-05-08 07:13:25** · branch `dry-loop-test-utils-load-lib-batch2-20260508-071325` · audit §P0 Test-Harness Consolidation (tsz-checker) — `load_lib_files_for_test` migration batch 2 (continues PR #4591) · migrate 3 more test files onto `tsz_checker::test_utils::{check_source_with_libs, load_lib_files, load_default_lib_files}`: `jsdoc_param_return_ts2314_tests.rs` (7 tests, −92 lines, uses `load_default_lib_files`), `infer_extends_constraint_substitution_tests.rs` (9 tests, −110 lines, custom es5+es2015 subset), `type_argument_inference_constraints_fingerprint_tests.rs` (3 tests, −110 lines, custom subset including DOM). Draft PR title: `chore(checker-tests): migrate batch 2 of load_lib_files_for_test variants onto test_utils`.
