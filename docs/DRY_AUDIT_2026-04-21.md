...
- **2026-05-08 07:33:10** · branch `dry-loop-test-utils-load-lib-batch3-20260508-073310` · PR #4606 (in flight) · `conformance_issues/core/helpers.rs` (-41, single-line delegate; 4 sub-tests inherit), `conformance_issues/types/enum.rs` (-42, delegate), `jsdoc_type_tag_tests.rs` (-177; 3 inline pipelines collapsed).
- **2026-05-08 07:47:33** · branch `dry-loop-test-utils-load-lib-batch4-20260508-074733` · audit §P0 Test-Harness Consolidation (tsz-checker) — `load_lib_files_for_test` migration batch 4 · `contextual_typing_tests.rs` (71 tests; -80 lines): 3 wrappers (`check_default`/`check_with_options`/`check_with_libs`) collapsed onto `check_source` + `check_source_with_libs(LIB_NAMES)`. Draft PR title: `chore(checker-tests): batch 4 of load_lib_files_for_test migration`.
