...
use crate::solver::subtype::{TypeEnvironment, are_types_structurally_identical};
use crate::solver::types::{TypeId, Visibility};
...
fn test_object_literal_identity() {
    ...
    let prop_a = crate::solver::types::PropertyInfo {
...
fn test_object_order_independence() {
    ...
    let prop_b = crate::solver::types::PropertyInfo {
...
fn test_optional_matters() {
    ...
    let prop_required = crate::solver::types::PropertyInfo {
        name: interner.intern_string("a"),
        type_id: TypeId::NUMBER,
        write_type: TypeId::NUMBER,
        optional: false,
    ...
    let prop_optional = crate::solver::types::PropertyInfo {
        name: interner.intern_string("a"),
        type_id: TypeId::NUMBER,
        write_type: TypeId::NUMBER,
        optional: true,
...
fn test_readonly_matters() {
    ...
    let prop_readonly = crate::solver::types::PropertyInfo {
        name: interner.intern_string("a"),
        type_id: TypeId::NUMBER,
        write_type: TypeId::NUMBER,
        optional: false,
    ...
    let prop_mutable = crate::solver::types::PropertyInfo {
        name: interner.intern_string("a"),
        type_id: TypeId::NUMBER,
        write_type: TypeId::NUMBER,
        optional: false,
...
fn test_nested_object_identity() {
    ...
    let inner_prop = crate::solver::types::PropertyInfo {
    ...
    let outer_prop = crate::solver::types::PropertyInfo {
