//! Property Assignment Flow Analysis Module
//!
//! This module contains flow analysis utilities for tracking property assignments
//! in constructors and class bodies. This is used for:
